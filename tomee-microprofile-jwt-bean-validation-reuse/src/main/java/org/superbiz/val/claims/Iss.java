...
@Documented
@RequireClaim("iss")
@javax.validation.Constraint(validatedBy = {Iss.Constraint.class})
...
public @interface Iss {
    ...
    class Constraint implements ConstraintValidator<Iss, JsonWebToken> {
        private Iss iss;

        @Override
        public void initialize(final Iss constraint) {
            this.iss = constraint;
        }
        ...
        public boolean isValid(final JsonWebToken value, final ConstraintValidatorContext context) {
            ...
            return this.iss.value().equals(issuer);
        }
    }
}
